...
async def get_thumb(videoid: str):
    ...
    try:
        ...
        icons = Image.open("maythusharmusic/assets/icons.png")
        ...
        font_info = ImageFont.truetype("maythusharmusic/assets/font2.ttf", 28)
        font_time = ImageFont.truetype("maythusharmusic/assets/font2.ttf", 26)
        font_path = "maythusharmusic/assets/font3.ttf"
        ...
        watermark_font = ImageFont.truetype("maythusharmusic/assets/font2.ttf", 24)
        watermark_text = "Team maythusharmusic"
