...
@app.on_callback_query(filters.regex("CailinmousAdmin") & ~BANNED_USERS)
async def Cailinmous_check(client, CallbackQuery):
    try:
        await CallbackQuery.answer(
...
@app.on_callback_query(filters.regex("CailinPlaylists") & ~BANNED_USERS)
@languageCB
